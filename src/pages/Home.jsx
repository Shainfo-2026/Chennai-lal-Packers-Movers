...
`;
    ...
    if (!document.getElementById("aboutslide-style")) {
  const style = document.createElement("style");
  style.id = "aboutslide-style";
  style.innerHTML = css;
...
/>
        ...
        <div className="sps-about-content">
          ...
          <Link to="/about" className="sps-about-btn">
            Know More About Us
          </Link>
        </div>
...
.why-item:hover{
  transform:translateY(-4px);
  box-shadow:0 10px 20px rgba(6,34,66,0.12);
}
...
`;
    ...
    if (!document.getElementById("whychoose-style")) {
  const style = document.createElement("style");
  style.id = "whychoose-style";
  style.innerHTML = css;
  document.head.appendChild(style);
}
...
`;
   ...
   if (!document.getElementById("features-style")) {
  const style = document.createElement("style");
  style.id = "features-style";
  style.innerHTML = css;
  document.head.appendChild(style);
}
...
.strength-item {
  ...
  border: 5px solid rgba(15, 144, 8, 0.2);
...
`;
   ...
   if (!document.getElementById("strengths-style")) {
  const style = document.createElement("style");
  style.id = "strengths-style";
  style.innerHTML = css;
  document.head.appendChild(style);
}
...
`;
    ...
    if (!document.getElementById("routes-strip-style")) {
  const style = document.createElement("style");
  style.id = "routes-strip-style";
  style.innerHTML = css;
  document.head.appendChild(style);
}
