...
export default function Madipakkam() {
...
.madi-top {
  ...
  background-image: url("/images/about/madi.png");
...
@media (max-width: 600px) {
  .madi-top {
    min-height: 260px;
 background-image: url("/images/about/mmadi.png");
  ...
  return (
    <>
      ...
      <Helmet>
              ...
              <link rel="canonical" href="https://www.chennailalpackersmovers.com/services/madipakkam" />
